...
* [Introduction to the AVR](basics/overview-of-the-avr.md)
  * [Interfacing I/O ports](basics/interfacing-i-o-ports/README.md)
    * [Embedded Systems 101: Blinking an LED](basics/interfacing-i-o-ports/led-blink.md)
  * [Interrupts](basics/interrupts/README.md)
  * [Timers](basics/timers/README.md)
    * [Basics of AVR Timers](basics/timers/basics.md)
  ...
  * [AVR Memory](basics/memory/README.md)
    * [EEPROM](basics/memory/EEPROM.md)
    * [Flash Memory](basics/memory/flash-memory.md)
    * [SRAM](basics/memory/sram.md)
  * [Power Management](basics/power-management.md)
  * [Debugging](basics/debugging.md)
  * [Watchdog Timer](basics/watchdog.md)

## Writing Hardware Drivers

* [Displays](drivers/displays/README.md)
  * [LCD](drivers/displays/lcd.md)
  * [LED Matrix](drivers/displays/led-matrix.md)
  * [Seven Segment](drivers/displays/7-seg.md)
* [Push Buttons](drivers/push-buttons.md)
* [Motors](drivers/motors/README.md)
  * [DC Motors](drivers/motors/dc-motor.md)
...
* [Communication](drivers/communication/README.md)
  ...
  * [NFC](drivers/communication/nfc.md)
